...
from wge.miniwob.action import MiniWoBCoordClick, MiniWoBElementClick, MiniWoBTerminate
...
class MiniWoBTester(object):
    ...
    def env(self):
        ...
        base_url = os.getenv('MINIWOB_BASE_URL')    # os.environ.get('MINIWOB_BASE_URL')
...
class TestMiniWoBEnvironment(MiniWoBTester):
    ...
    def test_run(self, env):
        ...
        # TODO: remove, it won't ever pass in python3
        # assert all(x.fields.keys == ['dummy'] for x in states), "python3 won't pass this, it's fine"
...
class TestMiniWoBFields(MiniWoBTester):
    ...
    def test_fields(self, env):
        ...
        for state in states:
            print(state.utterance)
            print(state.fields)
            # TODO: remove check, won't ever pass in python3
